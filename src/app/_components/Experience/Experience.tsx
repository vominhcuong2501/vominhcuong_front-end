...
const Experience = () => {
	...
	return (
		<div
			className="relative mx-auto flex h-screen max-w-[1200px] items-center justify-center px-5 pt-14 text-center lg:text-left"
		...
		>
			...
			>
				<Swiper
					...
					navigation={{
						nextEl: ".trust-pilot-arrow-left",
						prevEl: ".trust-pilot-arrow-right",
					}}
					slidesPerView={1}
					effect={"fade"}
					pagination={{
				...
				<button className="trust-pilot-arrow-left absolute right-0 -translate-y-1/2 top-1/2 z-10 hidden bg-white cursor-pointer rounded-full border hover:border-red-1 hover:fill-red-1 p-[11px] duration-200  md:block">
					<svg
				...
				<button className="trust-pilot-arrow-right absolute left-0 -translate-y-1/2 top-1/2 z-10 hidden bg-white cursor-pointer rounded-full border hover:border-red-1 hover:fill-red-1 p-[11px] duration-200 md:block">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="14"
						height="14"
