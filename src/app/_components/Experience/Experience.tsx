      ...
      <div className="absolute top-1/2 -translate-y-[50%]">
        ...
        >
          <Swiper
            ...
            className="mySwiper max-w-[343px] md:max-w-[500px] lg:max-w-[900px] !pb-10"
            slidesPerView={1}
            effect={"fade"}
            pagination={{
              clickable: true,
            ...
            {data?.map((item, index) => {
              return (
                <SwiperSlide key={index}>
                  <article className="mx-auto flex h-full w-full items-center justify-center transition-all md:w-[500px] md:gap-4 lg:w-[800px]">
