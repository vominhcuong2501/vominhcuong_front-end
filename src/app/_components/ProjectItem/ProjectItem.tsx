	...
	return (
		<div className={` relative  group `}>
			...
			>
				...
				>
					<h3 className="text-20 font-bold uppercase md:text-24 ">
						{content?.nameProject}
					</h3>
					<div className="mx-auto flex w-full flex-wrap justify-center gap-2 text-14 md:text-16 mt-1">
					...
					<div
						className=" mx-auto mt-4 w-full max-w-[600px] text-left text-14 md:text-16"
