...
the provided design and analysis documentation.
    ...
    {
      imgProject: "/project-forex.jpg",
      nameProject: "Forexcec",
      listIcon: [
        {
          name: "HTML",
          icon: "/icon_html.webp",
      ...
      content: `<ul class="pl-5 list-disc">
			  ...
			  <li class="text-14 lg:text-16">
			  Project description: This is a commercial website, used to introduce and guide
international trade transactions.
			  </li>
			  <li class="text-14 lg:text-16">Number of participants: 4</li>
			  <li class="text-14 lg:text-16">Technologies utilized: HTML, CSS, JS, PHP</li>
			  <li class="text-14 lg:text-16">
			  Tasks in the project: Build a website interface by design from figma into code.
			  </li>
		  </ul>`,
  ...
  return (
    ...
    >
      <h2 className="lg:absolute lg:top-8 z-10 translate-x-3 text-16 uppercase tracking-[20px] md:text-32 font-bold pb-2 lg:pb-0">
        Project
      </h2>
      ...
      >
        <Swiper
          ...
          className="mySwiper max-w-[343px] md:max-w-[700px] !pb-10"
          slidesPerView={1}
          pagination={{
            clickable: true,
          }}
              ...
              <SwiperSlide key={index}>
                ...
                >
                  <motion.img
                    ...
                    className="mx-auto block rounded-[16px] max-w-[400px]"
                  />
                  <motion.div
                    initial={{ translateY: 100 }}
                    whileInView={{ translateY: 0 }}
                  ...
                  >
                    <h2 className="mt-2 text-18 font-bold uppercase md:text-24">
                      {item.nameProject}
                    </h2>
